...
import com.makotogroup.sample.wicket.OpenIdRegistrationSavePage;
...
public class RegistrationService {
  ...
  public static String getReturnToUrl() {
    return RequestUtils.toAbsolutePath(RequestCycle.get().urlFor(OpenIdRegistrationSavePage.class,
        OpenIdRegistrationSavePage.createParams(true)).toString());
  }
}
