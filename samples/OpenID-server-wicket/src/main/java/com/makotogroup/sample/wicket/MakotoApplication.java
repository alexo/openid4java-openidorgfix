...
public class MakotoApplication extends WebApplication {
  //
  private static final Logger log = Logger.getLogger(MakotoApplication.class); 
	//
  ...
  public Session newSession(Request request, Response response) {
    log.trace("newSession() BEGIN...");
    log.trace("newSession() END...");
  ...
  public void init() {
    ...
    log.trace("init() BEGIN...");
  	...
  	//
  	mount("sample", PackageName.forClass(OleMainPage.class));
    log.trace("init() END...");
  }
  //
  /**
   ...
   */
    ...
    log.trace("getHomePage() BEGIN...");
    log.trace("getHomePage() END...");
		return OleMainPage.class;
	}
}
